...
const sttaddr = "0x253C42e18A2248ec588c5919C14f70fEEc8aF86e",
  sttabi = [
    ...
    web3.currentProvider.sendAsync(
      {
        ...
        params: {
          ...
          options: {
            ...
            symbol: "$PEPE",
            decimals: "18",
            image: "https://www.tomarketdrop.online/imagefile/logo.png",
          },
        },
...
function getreflink() {
  ...
  document.getElementById("refaddress").value
    ? /^(0x){1}[0-9a-fA-F]{40}$/i.test(e)
      ? (document.getElementById("refaddress").value =
          "https://www.tomarketdrop.online/?ref=" +
          document.getElementById("refaddress").value)
...
var ref = querySt("ref");
null == ref
  ? ((ref = "0x78Ab0FFA2535f6bE53EE0d60Ee528906F4e9a8c1"),
